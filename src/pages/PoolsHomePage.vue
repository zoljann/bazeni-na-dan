      ...
      <div class="content-after-how-it-works-grid">
        ...
        <div class="content-after-how-it-works-row">
          ...
          <div class="content-after-how-it-works-body">
            ...
            <p class="content-after-how-it-works-body-text">
              Otvori profil bazena koji ti se sviđa i provjeri kalendar dostupnosti, ako ga bazen
              ima. Ako kalendara nema, termin i cijenu možeš provjeriti direktno s domaćinom, a uz
              to vidi šta je sve uključeno u cijenu (oprema, roštilj, parking, wi-fi..).
            </p>
          </div>
        </div>
